...
%Using these descriptors and the specified epsilon, we trained a
% unigram language model.


%% The smoothing parameter,
%% $\epsilon$, for the language model was 0.0001. Tuning this parameter
%% had little effect due to the size of our language model.
