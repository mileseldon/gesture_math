...
tracker~\citep{openni} and define our models for hand and head
...
vector from the elbow to the wrist.  For head pose, we compute a
...
16 unique words, containing common descriptors for the
