...
\citet{clark96} pointed out that language use, and more broadly,
communication, takes place as joint activity.  Two people
participating in a joint activitly constantly monitor each other's
mental state.  Our approach represents first step toward enabling a
robot to make these same sorts of inferences.

LP's paper about head nods
